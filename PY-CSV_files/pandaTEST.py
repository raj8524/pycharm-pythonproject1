...
# import os
# # print(os.getcwd())
# df=pd.read_csv('/Users/raj.kumar/Desktop/pythonProject1/final.csv')
# print(df['input_rate'].max())
import sys
import pandas as pd
...
with open(r"/Users/raj.kumar/Desktop/pythonProject1/devices1.txt")as f:
