...
//use clearintervaL(clr) /CLEARTIMEOUT TO CANCEAL setInterval/setTimeout
...
jso=JSON.stringify(obj);   //json to string
console.log(typeof jso)
console.log(jso)
parsed=JSON.parse(`"name":"harry","length":1,"a":{this:'that'}}`)         //sting to json
console.log(parsed)
*/


//javascript localstroge
/*
